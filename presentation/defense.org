...
#+REVEAL_INIT_SCRIPT: dependencies: [{ src: 'http://localhost:3001/socket.io/socket.io.js', async: true }, { src: 'reveal.js/plugins/plugin/remote-control/remote.js', async: true }]
