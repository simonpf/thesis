...
\newcommand{\ttlpage}[0]{
  \vspace{1.0cm}
  \begin{center}
    \includegraphics[width=\textwidth]{title_page}
  \end{center}
  \vspace{3cm}
 \vfill
}
...
\input{chapters/radiative_transfer_theory}
...
\cleardoublepage            % skip back side of the page
\includepdf[pages=-]{papers/gprof_nn}
...
\chaptermark{GPROF: Evolution and validation}
\label{chap:qrnn}
\thispagestyle{empty}       % no page numbers
\cleardoublepage            % skip back side of the page
\includepdf[pages=-]{papers/gprof_nn_validation}
...
\thispagestyle{empty}       % no page numbers
\cleardoublepage            % skip back side of the page
\includepdf[pages=-]{papers/hydronn}
